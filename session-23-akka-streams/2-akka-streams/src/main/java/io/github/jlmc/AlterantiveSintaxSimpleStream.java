 ...
 * </pre>
 */
public class AlterantiveSintaxSimpleStream {
    public static void main(String[] args) {
        ...
        Sink<String, CompletionStage<Done>> sink =
                Sink.foreach(AlterantiveSintaxSimpleStream::doSomething);
        ...
        // graph.run(system);
        //sink.runWith(cycle, system);
        //cycle.via(flow).runForeach(str -> doSomething(str), system);

        cycle.via(flow).to(sink).run(system);
